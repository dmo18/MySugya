...
|---|---|---|---|---|---|---|
| 1 | 80a | 65 | 14 | (pending) | (pending) | applying |
| 2 | 80b | 56 | 12 | (pending) | (pending) | not started |
...
**Batch 038: IN PROGRESS.** Child 1/6 (80a) applying. Final disposition
...
updated as each child PR merges; batch 038 is COMPLETE only when all six

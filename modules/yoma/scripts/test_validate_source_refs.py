...
check("corpus totals exactly 1955 refs (1622 OK + 331 string + 2 crossDaf)",
      counts["OK"] == 1622 and counts["STRING_RESOLVABLE"] == 331 and
      counts["OK_CROSSDAF"] == 2 and total == 1955, str(dict(counts)))
